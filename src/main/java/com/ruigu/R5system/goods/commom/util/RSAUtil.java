package com.ruigu.R5system.goods.commom.util;
...
public class RSAUtil {
    ...
    public static String encryptData(String keyStr, String data) throws Exception {
        ...
        return encryptBASE64(encrypt(getPublicKey(keyStr), data.getBytes()));
    }
...
//            System.out.println("用公钥解密后的结果是:" + jiemi);
            ...
            String s = encryptData("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCt42UF3qT0dA2ogXB+OaOaZPE5PV3i9Mrrcfd0d0XkrQk3DYpAkUGAEfDqhGIH6ELcF4aF3FiytBw5cUD3GJDY04A+qJ4TgXRWYt4ErNH8HyTLvhtNLkg/xPd8TJ32ky+IIuJkvo0tOjCKEhg9PUhuMQ+ZvW77rm42DxgH4G0lrwIDAQAB"," ");
            String result = URLEncoder.encode(s, StandardCharsets.UTF_8.name());
